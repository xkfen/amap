...
// toWho:日志标识第三方名称
func PostForm(reqUrl string, jsonParams interface{}, toWho string, isLogResult bool) ([]byte, error) {
	var params url.Values = url.Values{}
	var jsonObj map[string]interface{}
	jsonB := util.StringifyJsonToBytes(jsonParams)
	logger.Info("["+toWho+"]请求参数:"+string(jsonB), "url", reqUrl)
	util.ParseJsonFromBytes(jsonB, &jsonObj)
